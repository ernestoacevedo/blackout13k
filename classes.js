...
class Enemy {
    ...
    atacc() {
        ...
        eventQ.push(function(){setDialog(enemy.name + " attacks")})
        eventQ.push(function(){setDialog("you received " + mainC.protecc(dmg) + " damage.")})
    ...
    performDeath(){
        var name = this.name
        eventQ.push(function(){setDialog(name + " was defeated")})
        eventQ.push(function(){switchState("explore")})
    }
